...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleHttpMessageNotReadableException(
        ...
        if (message != null && message.contains("Cannot deserialize value of type")
                && message.contains("PriorityLevel")) {
            // Extract the valid values from error message
            // Error format: "Cannot deserialize value of type
            // `com.example.cyclemartberemake.entity.PriorityLevel` from String \"PLATINU\":
            // not one of the values accepted for Enum class: [GOLD, PLATINUM, SILVER]"
    ...
    public ResponseEntity<Map<String, Object>> handlePropertyReferenceException(
        ...
        response.put("message",
                "Trường sort không hợp lệ. Các trường hợp lệ: id, title, price, createdAt, updatedAt, postStatus, brand, city, year");
        response.put("validSortFields", new String[] { "id", "title", "price", "createdAt", "updatedAt", "postStatus",
                "brand", "city", "year" });
